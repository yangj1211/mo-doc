...
::::{tab-item} **下载方式一：`wget` 工具下载安装二进制包**
 x86 架构系统安装包：

 ```bash
 wget https://github.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-x86_64.zip
 unzip mo-v2.2.2-musl-x86_64.zip
 ```

 ARM 架构系统安装包：

 ```bash
 wget https://github.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-arm64.zip
 unzip mo-v2.2.2-musl-arm64.zip
 ```

如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

```
wget https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-xxx.zip
```
::::
...
::::{tab-item} **下载方式二：`curl` 工具下载二进制包**
 ...
 ```bash
 curl -OL https://github.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-x86_64.zip
 unzip mo-v2.2.2-musl-x86_64.zip
 ```
 ...
 ```bash
 curl -OL https://github.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-arm64.zip
 unzip mo-v2.2.2-musl-arm64.zip
 ```
...
```
curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-musl-xxx.zip
```
::::

::::{tab-item} **下载方式三：页面下载**
 如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 2.2.2](https://github.com/matrixorigin/matrixone/releases/tag/v2.2.2)，下拉找到 **Assets** 栏，点击安装包 *mo-v2.2.2-musl-x86_64.zip* 或者 *mo-v2.2.2-musl-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
::::
:::::
### 基于 glibc 构建的二进制包
...
::::{tab-item} **下载方式一：`wget` 工具下载安装二进制包**
 ...
 unzip mo-v2.2.2-linux-x86_64.zip
 ```
 ...
 unzip mo-v2.2.2-linux-arm64.zip
 ```

如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

```
wget https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-linux-xxx.zip
```
::::
...
```
curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-linux-xxx.zip
```
::::

::::{tab-item} **下载方式三：页面下载**
 如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 2.2.2](https://github.com/matrixorigin/matrixone/releases/tag/v2.2.2)，下拉找到 **Assets** 栏，点击安装包 *mo-v2.2.2-linux-x86_64.zip* 或者 *mo-v2.2.2-linux-arm64.zip* 下载再使用 ```unzip``` 命令解压即可。
::::
:::::
## 步骤 3：安装 mo_ctl 工具
...
```
mo_ctl set_conf MO_PATH="/yourpath/mo-v2.2.2-xx-xx" #设置MatrixOne路径为二进制解压文件目录
mo_ctl set_conf MO_CONF_FILE="/yourpath/mo-v2.2.2-xx-xx/etc/launch/launch.toml" #设置MatrixOne配置文件路径
...
如果运行正常将出现以下日志。MatrixOne 的相关运行日志会在 `/yourpath/mo-v2.2.2-xx-xx/matrixone/logs/` 中。
