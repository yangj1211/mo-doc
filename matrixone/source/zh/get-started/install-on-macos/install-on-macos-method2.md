...
::::{tab-item} **下载方式一：`wget` 工具下载安装二进制包**
 ...
 unzip mo-v2.2.2-darwin-x86_64.zip
 ```
 ...
 unzip mo-v2.2.2-darwin-arm64.zip
 ```

如 github 原地址下载过慢，您可尝试从以下地址下载镜像包：

```
wget https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-darwin-xxx.zip
```
::::
...
```
curl -OL https://githubfast.com/matrixorigin/matrixone/releases/download/v2.2.2/mo-v2.2.2-darwin-xxx.zip
```
::::

::::{tab-item} **下载方式三：页面下载**
 如果你想通过更直观的页面下载的方式下载，直接点击进入[版本 2.2.2](https://github.com/matrixorigin/matrixone/releases/tag/v2.2.2)，下拉找到 **Assets** 栏，点击安装包 *mo-v2.2.2-darwin-x86_64.zip* 或 *mo-v2.2.2-darwin-arm64.zip* 下载即可。
::::
:::::
## 步骤 3：安装 mo_ctl 工具
