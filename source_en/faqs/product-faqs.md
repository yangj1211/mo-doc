...
To learn more, see [MatrixOne Introduction](../overview/matrixone-introduction.md).
...
See [MySQL compatibility](../overview/feature/mysql-compatibility.md) for details.
...
MatrixOne is highly compatible with MySQL 8.0 — SQL syntax, wire protocol, operators, and functions. For the full compatibility gap list, see [MySQL compatibility](../overview/feature/mysql-compatibility.md).
