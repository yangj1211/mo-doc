...
* 已完成[创建实例](../../instance/create-instance/create-serverless-instance.md)，并通过 MySQL 客户端连接 MatrixOne Intelligence 并创建一个命名为 *test* 的数据库：
...
你可以参考 [Golang 连接 MatrixOne Intelligence 服务](../../instance/drivers/go.md)了解如何通过 `Golang` 连接到 MatrixOne Intelligence，本篇文档将指导你如何实现 CRUD（创建、读取、更新、删除）。
